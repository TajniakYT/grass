...
{
	EndGame.para.first = StatFab.tura;
	EndGame.para.second = EndGame.score;
}
void wypiszKoncowyWynik(WynikGry EndGame)
{
	std::cout << "Koncowy wynik to: " << EndGame.para.first * EndGame.para.second << " punktow" << std::endl;
}
